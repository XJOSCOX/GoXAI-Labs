...
function getTopbarTitle(pathname: string) {
  ...
  if (normalizedPathname === "/label-templates") {
    return { eyebrow: "Label settings", title: "Template browser" };
  }

  if (normalizedPathname === "/label-templates/manage") {
  ...
  if (normalizedPathname.startsWith("/label-templates/templates/")) {
    return { eyebrow: "Label settings", title: "Edit template" };
  }
